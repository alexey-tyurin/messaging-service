...
def upgrade() -> None:
    ...
    op.create_table('conversations',
        ...
        sa.Column('channel_type', sa.Enum('sms', 'mms', 'email', 'voice_call', 'voicemail', name='messagetype'), nullable=False),
    ...
    op.create_table('messages',
        ...
        sa.Column('message_type', sa.Enum('sms', 'mms', 'email', 'voice_call', 'voicemail', name='messagetype'), nullable=False),
